...
module.exports = class TufteSuitePlugin extends obsidian.Plugin {
  ...
  async filterChineseFamilies(families) {
    ...
    const re = /[㐀-鿿　-〿]|(SC|TC|GB|CN|HK)|CJK|Song|Sung|Hei|Heiti|Kai|Ming|Yuan|FangSong|Fang Song|Sim(Sun|Hei)|YaHei|DengXian|PingFang|Source Han|WenQuanYi|LXGW|Sarasa|HarmonyOS Sans SC|MiSans/i;
